...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'main1.data';
      var REMOTE_PACKAGE_BASE = 'main1.data';
...
var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_main1.data');

      };
      Module['addRunDependency']('datafile_main1.data');
    ...
    loadPackage({"files": [{"filename": "/hello_world_file.txt", "start": 0, "end": 70}], "remote_package_size": 70});
